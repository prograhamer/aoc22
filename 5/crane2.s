...
remove_from_stack:
	...
	movl %r10d, (%rdi)
	test %r10d, %r10d
	je remove_from_stack_done

	xor %r11, %r11
remove_from_stack_loop:
	movb 0x5(%rdi, %r11, 1), %al
	movb %al, 0x4(%rdi, %r11, 1)
	inc %r11
	cmp %r11d, %r10d
	jg remove_from_stack_loop

remove_from_stack_done:
	movb 0x4(%rdi), %al
remove_from_stack_ret:
	ret
remove_from_stack_err:
	mov $-1, %rax
	jmp remove_from_stack_ret

// move_between_stacks(stack *from, stack *to, int count)
move_between_stacks:
	movl (%rdi), %r10d
	cmp %edx, %r10d
	jl move_between_stacks_err
	sub %edx, %r10d
	movl %r10d, (%rdi)
	...
	// source pointer
	leaq 0x4(%rdi, %r10, 1), %r8
	mov %r8, %rcx
	add %rdx, %rcx
	// dest pointer
	leaq 0x4(%rsi, %r11, 1), %r9
...
move_between_stacks_ret:
	ret
move_between_stacks_err:
	mov $-1, %rax
	jmp move_between_stacks_ret
